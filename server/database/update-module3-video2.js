...
const orderIndex = 2;
const videoTitle = 'การจัดการอุปกรณ์และความสะอาด - วิดีโอที่ 2';
const videoUrl = '/uploads/videos/video-module_3-2.mp4';

console.log('📹 Adding video to module_3 (order 2)...\n');
